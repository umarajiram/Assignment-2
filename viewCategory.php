                    ...
                    <div class="card-body "style="width:100%">
                        <table class="table table-bordered text-center">
                            ...
                            <tr>
                                ...
                                <td><a href="editCategory.php?GetID=<?php echo $UserID ?>" class="btn btn-primary">edit</a></td>
                                
                                <td><a href="deleteCategory.php?Del=<?php echo $UserID ?>" class="btn btn-danger">Delete</a></td>
