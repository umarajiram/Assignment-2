...
<div class="row"> 
   ...
   <div class="col-lg-8 col-lg-offset-2"> 
        ...
        <form method="post" action="categoryInsert.php">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <input id="form_product_category" type="text" name="product_category" class="form-control" placeholder="Please enter product category name*" required="required" data-error="product category name is required.">
