                    ...
                    <div class="card-body "style="width:100%">
                        <table class="table table-bordered text-center">
                            ...
                            <tr>
                                ...
                                <td><a href="editSubCategory.php?GetID=<?php echo $UserID ?>" class="btn btn-primary">edit</a></td>
                                
                                <td><a href="deleteSubCategory.php?Del=<?php echo $UserID ?>" class="btn btn-danger">Delete</a></td>
