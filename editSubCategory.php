...
$UserID = $_GET['GetID'];
$query = "select * from subcategory where id='".$UserID."'";
...
<div class="row"> 
   ...
   <div class="col-lg-8 col-lg-offset-2"> 
        ...
        <form method="post" action="updateSubCategory.php?ID=<?php echo $UserID ?>">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <input id="form_product_category" type="text" name="product_subcategory" class="form-control" placeholder="Please enter product Sub-category name*" required="required" data-error="product category name is required." value="<?php echo $product_subcategory?>">
