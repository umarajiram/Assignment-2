...
<div class="row"> 
   ...
   <div class="col-lg-8 col-lg-offset-2"> 
        ...
        <form method="post" action="subCategoryInsert.php">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <input id="form_product" type="text" name="product_subcategory" class="form-control" placeholder="Please enter product Sub-category name*" required="required" data-error="product Sub-category name is required.">
